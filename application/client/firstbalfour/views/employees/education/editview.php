                ...
                <div class="form-multiple-add" style="display: block;">
                    ...
                    <div class="form-item odd">
                        ...
                        <div class="radio-input-wrap">
                            <?=form_radio('education[graduate][' . $no . ']', 1, ($data['graduate'] == '1' ? true : false), 'class="radioG"')?>Graduate
                            <?=form_radio('education[graduate][' . $no .']', 0, ($data['graduate'] == '0' ? true : false), 'class="radioUG"')?>Undergraduate
                        </div>                
                    </div>                     
