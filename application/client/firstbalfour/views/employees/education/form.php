...
<div class="form-multiple-add" style="display: block;">
    ...
    <div class="form-item even hidden">
        ...
        <div class="select-input-wrap">
            <?php
                ...
                print '<select id="education_school" name="education[education_school_id][]">
    ...
    <div class="form-item even hidden">
        <label class="label-desc gray" for="education[education_school][]">School:</label>                      
    ...
    <div class="form-item odd">
        ...
        <div class="radio-input-wrap">
            <input type="radio" name="education[graduate][<?= $key ?>]" value="1" class="radioG" checked/>Graduate
        ...
        <div class="select-input-wrap">
            <?php                     
                ...
                print '<select id="degree_obtained" name="education[employee_degree_obtained_id][]">
                    <option value="" selected>Select degree obtained...</option>';                
...
<!--         <div class="text-input-wrap">
            <input type="text" class="input-text" value="" name="education[degree][]">
        </div> -->
    </div>
