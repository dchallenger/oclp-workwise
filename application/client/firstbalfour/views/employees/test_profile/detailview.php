    ...
    if (count($test_profile) > 0):
        foreach ($test_profile as $data):
            ...
            <div>
                ...
                <div class="form-item even <?php echo (($data['exam_type'] == 'Government Examination' || $data['exam_type'] == '') ? 'hidden' : '')?>">
                ...
                <div class="form-item even <?php echo (($data['exam_type'] == 'Professional Exam' || $data['exam_type'] == '') ? 'hidden' : '')?>">
                    <label class="label-desc gray" for="test_profile[exam_title][]">
                        Exam Title:
                    </label>
                    <div class="text-input-wrap"><?= $data['exam_title'] ?></div> 
                </div>                
                <div class="form-item even <?php echo ($data['exam_type'] == 'Government Examination' ? 'hidden' : '')?>">
                ...
                <div class="form-item even">
                    ...
                    <div class="text-input-wrap"><?= ($data['score_rating'] != 0.00 ? $data['score_rating'] : '') ?></div> 
                </div>
                <div class="form-item odd">
