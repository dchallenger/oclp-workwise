    ...
    if (count($test_profile) > 0):
        ...
        foreach ($test_profile as $data):
            ...
            <div class="form-multiple-add" style="display: block;">
                ...
                <div class="form-item even <?php echo (($data['exam_type'] == 'Professional Exam' || $data['exam_type'] == '') ? 'hidden' : '')?>" id="exam_title">
                    <label class="label-desc gray" for="test_profile[exam_title][]">
                        Exam Title:
                    </label>
                ...
                <div class="form-item even <?php echo ($data['exam_type'] == 'Government Examination' ? 'hidden' : '')?>" id="license_no">
                    <label class="label-desc gray" for="test_profile[license_no][]">
                        License No.:
                    </label>
                    <div class="text-input-wrap">
                        <input type="text" class="input-text" value="<?= $data['license_no']?>" name="test_profile[license_no][]" /> <span></span>
                    </div>
                </div>                                
                <div class="form-item odd">
