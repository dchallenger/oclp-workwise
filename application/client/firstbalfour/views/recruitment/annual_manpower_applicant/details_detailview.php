...
<input type="hidden" id="existing" value="<?=$existing?>">
    ...
    <table class="default-table boxtype" style="width:100%" id="module-access">
            ...
            <tbody class="structure_list">
                ...
                <td style="vertical-align:middle; text-align:center;"><?=$user_row->job_rank?></td>
                ...
                <td axis="<?=strtolower($month)?>" style="vertical-align:middle; text-align:center;" class="text-center <?=($index % 2 == 0 ? "even" : "odd")?> ">
                   <?php 
                            ...
                            <?=($user_row->{$monthsmall} == $row_remarks->annual_manpower_planning_remarks_id ? $row_remarks->remarks : "")?>
                ...
                <?php   }
                ?>
                <td style="vertical-align:middle; text-align:center;"><?=$user_row->budget?></td>
                            ...
                            <?php  if ($existing): 
                              ...
                              <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:center"><?=($incumbent_arr[$existing_pos['position_id']]) ? $incumbent_arr[$existing_pos['position_id']] : 0 ;?></td>
                                
                                <?php foreach ( $list_month as $m => $month ){ ?>

                                    <td style="text-align:center"><?=$existing_pos[strtolower($month)]?></td>

                               <?php } ?>
                                   <td style="text-align:center"><?=$existing_pos['total']?></td>
                                  <td style="text-align:center"><?=$existing_pos['budget']?></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                </tr>   
                            <?php   endforeach;?>
    ...
    <table id="module-new-headcount" style="width:100%" class="default-table boxtype">
        ...
        <?php $new_position_list = $new_position->result_array();
            ...
            foreach( $new_position_list as $key => $val ){
                ...
                ?>
            <tr>
                <th style="vertical-align:middle; text-align:center; border-top: none; padding: 10px;" class="text-left even">Position:</th>
                <th class="text-left even" style="vertical-align:middle; border-top: none; padding: 10px;" colspan="14"><?=$new_position_list[$key]['position'];?></th>
                <th style="vertical-align:middle; border-top: none; padding: 10px;" class="text-left even" colspan="2"></th>
            </tr>
            ...
            <tr class="new_job_form">
                <th style="border-top: none; text-align:center;">Headcount
                    ...
                    ?>
                                <td axis="<?php echo strtolower($month); ?>" style="vertical-align:middle; text-align:center;" class="text-center <?php echo ($index % 2 == 0 ? "even" : "odd"); ?> "><?=$new_position_list[$key][strtolower($month)]; ?></td>
                    <?php
                            } 
                            ...
                            <td style="vertical-align:middle; text-align:center;" class="text-center even "><?=$new_position_list[$key]['total'];?></td>
                            <td style="vertical-align:middle; text-align:center;" class="text-center even "><?=$new_position_list[$key]['budget'];?></td>
                        </tr>
                        <tr>
                            ...
                            <?php echo $new_position_list[$key]['remarks']; ?></td>
                        </tr>
                         </tbody>
                    <?php 
                    }
