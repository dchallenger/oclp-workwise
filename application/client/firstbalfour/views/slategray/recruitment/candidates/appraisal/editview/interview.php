				...
				<div id="interviewer-container">
					...
					?>
								<div class="parent_container">
									<div class="form-item odd">
										<label class="label-desc gray" for="interview_id">
											Interviewer:
										</label>
											<div class="select-input-wrap">
												<?php if (count($interviewer) > 0): ?>
													<select class="interviewer_id" name="interviewer_id[]">
									...
									<div class="form-item1 even">
										...
										<div class="text-input-wrap"><input type="text" class="input-text datetimepicker" name="interview_date[]" value="<?= ($row_interviewer->datetime == "0000-00-00 00:00:00" ? "" : $row_interviewer->datetime) ?>"/></div>
									</div>
									...
									<div class="form-item2">
										<div style="padding-top:13px; width:100px;" class="icon-group">
												...
												<a class="icon-button icon-16-send-email icon-send" href="javascript:void(0)"></a>
										</div>
									</div>	
