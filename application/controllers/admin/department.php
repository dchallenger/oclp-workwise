...
class Department extends MY_Controller
{
	function __construct()
    {
		...
		$this->listview_title = 'Department';
		$this->listview_description = 'This  lists all defined department(s).';
		$this->jqgrid_title = "Departmet(s) List";
		$this->detailview_title = 'Department Info';
