...
class Employee_201_settings extends MY_Controller
{
	...
	function index()
    {
		...
		$data['edit_201_settings'] = $this->hdicore->_get_config('edit_201_settings');
	...
	function edit()
	{
		if($this->user_access[$this->module_id]['edit'] == 1){
			...
			if($data['edit_201_settings']['enable_edit'] == 1 ){
