...
class Leave_filing_setup extends MY_Controller
{
	...
	function get_record(){
		$result = $this->db->get_where('employee_type_leave_filing_setup',array('leave_filing_setup_id' => $this->input->post('record_id')));
