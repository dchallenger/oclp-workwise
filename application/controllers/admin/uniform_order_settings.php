...
class Uniform_order_settings extends MY_Controller
{
	...
	function index()
    {
		...
		$data['uniform_order_settings'] = $this->hdicore->_get_config('uniform_order_settings');
	...
	function edit()
	{
		if($this->user_access[$this->module_id]['edit'] == 1){
			...
			if($data['uniform_order_settings']['enable_edit'] == 1 ){
				$data['enable_edit_yes'] = "checked";
			}
			else{
				$data['enable_edit_no'] = "checked";
			}
