...
class User_rank extends MY_Controller
{
	function __construct()
    {
		...
		$this->listview_title = '';
		$this->listview_description = 'This module lists all defined rank(s).';
		$this->jqgrid_title = "RankList";
		$this->detailview_title = 'Rank Info';
		$this->detailview_description = 'This page shows detailed information about a particular rank.';
		$this->editview_title = 'Rank Add/Edit';
		$this->editview_description = 'This page allows saving/editing information about rank(s).';

		$this->default_sort_col = array('job_rank_short_code');
    }
	...
	function ajax_save()
	{	
		$this->db->query("UPDATE {$this->db->dbprefix}user_rank SET rank_index = rank_index + 1 WHERE rank_index >= {$this->input->post('rank_index')}");
		parent::ajax_save();		
