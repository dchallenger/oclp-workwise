...
class performance_evaluation_rating_report extends MY_Controller
{
	...
	function _set_listview_query($listview_id = '', $view_actions = true) {
		$this->listview_column_names = array('Name', 'Position', 'Level', 'Classification', 'Department', 'Division',
			
			'Financial Perspective', 'Mid Year', 'Year End', 
			'Customer Perspective', 'Mid Year', 'Year End', 
			'Best Business Practice<br />Perspective', 'Mid Year', 'Year End', 
			'Learning and Growth<br />Perspective', 'Mid Year', 'Year End', 

			'Customer Orientation', 'Comment', 
			'Professional Competence', 'Comment', 
			'Personal Management', 'Comment', 

			'Attendance and<br />Punctuality', 'Comment', 

			'Innovation', 'Comment', 
			'Relationships', 'Comment', 
			'Excellence', 'Comment', 

			'Coach&rsquo;s Rating', 'Coach&rsquo;s Comment');
		...
		$this->listview_columns = array(
				...
				array('name' => 'financial_perspective'), array('name' => 'financial_mid'), array('name' => 'financial_end'),
				array('name' => 'customer_perspective'), array('name' => 'customer_mid'), array('name' => 'customer_end'),
				array('name' => 'best_business_practice_perspective'), array('name' => 'best_business_practice_mid'), array('name' => 'best_business_practice_end'),
				array('name' => 'learning_and_growth_perspective'), array('name' => 'learning_and_growth_mid'), array('name' => 'learning_and_growth_end'),

				array('name' => 'customer_orientation'), array('name' => 'customer_orientation_comment'),
				array('name' => 'professional_competence'), array('name' => 'professional_competence_comment'),
				array('name' => 'personal_management'), array('name' => 'personal_management_comment'),

				array('name' => 'attendance_and_punctuality'), array('name' => 'attendance_and_punctuality_comment'),

				array('name' => 'innovation'), array('name' => 'innovation_comment'),
				array('name' => 'relationships'), array('name' => 'relationships_comment'),
				array('name' => 'excellence'), array('name' => 'excellence_comment'),

				array('name' => 'coachs_rating'), array('name' => 'comments')
			);                                     
    }
