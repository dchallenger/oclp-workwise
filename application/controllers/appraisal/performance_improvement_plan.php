...
class Performance_improvement_plan extends MY_Controller
{
  ...
  function index()
    ...
    $data['content'] = 'employees/appraisal/reports/performance_improvement_plan';
  ...
  function export() {
        ...
        $objPHPExcel->getProperties()->setTitle("Performance Improvement Plan Report")
                    ->setDescription("Performance Improvement Plan Report");
        ...
        for ($i=0; $i < 40; $i++) { 
          ...
          $objPHPExcel->getActiveSheet()->getColumnDimension($xcoor)->setWidth(3.5);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A1',  'Performance Improvement Plan', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A1')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A4',  'Employee Information', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->getStyle('A4')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A6',  'Full Name:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A7',  'Position Title:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A8',  'Department:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A9',  'Division:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A10',  'Department Head:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A11',  'Division Head:', PHPExcel_Cell_DataType::TYPE_STRING);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F6',  'Tirso Garcia Jr', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F6:Q6')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->mergeCells('F6:Q6');
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F7',  'Tirso Garcia Jr', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F7:Q7')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->mergeCells('F7:Q7');        
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F8',  'Tirso Garcia Jr', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F8:Q8')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->mergeCells('F8:Q8');                
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F9',  'Tirso Garcia Jr', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F9:Q9')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->mergeCells('F9:Q9');                        
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F10',  'Tirso Garcia Jr', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F10:Q10')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->mergeCells('F10:Q10');                                
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F11',  'Tirso Garcia Jr', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F11:Q11')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->mergeCells('F11:Q11');     
        $objPHPExcel->getActiveSheet()->getStyle('A4:r12')->applyFromArray($styleBorderOutline);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('T4',  'Review Information', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('T4')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('T6',  'This Performance Improvement Plan was agreed on:', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('T7',  'Date:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('T8',  'This Performance Improvement Plan was completed on:', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('T9',  'Date:', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('T10',  'Date Format: dd/mm/yy', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->getStyle('T4:AH10')->applyFromArray($styleBorderOutline);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A14',  'Conforme', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A14')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A16',  'The Performance Improvement Plan (PIP) is a tool to identify, document and take action on specific job performance areas that needs to be improved to meet the standards of Ortigas & Company.                                                                    
 The PIP is agreed between the employee and his/her immediate superior within 30 days of issuance of Performance Appraisal Form and the employee is given six months to demonstrate improvement in performance following the agreed Performance Improvement Plan.
Failure to meet a satisfactory level of performance as defined in the Performance improvement plan may result to disciplinary action.', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A16:AH21');        
        $objPHPExcel->getActiveSheet()->getStyle('A16:AH21')->getAlignment()->setWrapText(true);   
        $objPHPExcel->getActiveSheet()->getStyle('A14:AH21')->applyFromArray($styleBorderOutline);      

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B23',  'Improvement Objectives', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B23')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B25',  'Step 1 - PIP Agreement:', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->getStyle('B25')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B26',  'Enter between one and five key performance improvement objectives. The objectives should be clearly defined with goals and measurement.', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('B26:AH27');
        $objPHPExcel->getActiveSheet()->getStyle('B26:AH27')->getAlignment()->setWrapText(true);  

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B29',  'Step 2 - PIP Action and Conclusion:', PHPExcel_Cell_DataType::TYPE_STRING);        
        $objPHPExcel->getActiveSheet()->getStyle('B29')->applyFromArray($styleArray); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B30',  'Performance should be regularly reviewed within the six months period.
Each objective should show clear performance improvement. Rate the outcome of each improvement objective using our five point rating scale.  (Exceptional Contributor - 5, Strong Contributor - 4, Effective Contributor - 3, Requires Improvement - 2, Poor Performance - 1)', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('B30:AH33');
        $objPHPExcel->getActiveSheet()->getStyle('B30:AH33')->getAlignment()->setWrapText(true);     

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A35',  'Area/s for  Improvement', PHPExcel_Cell_DataType::TYPE_STRING);                                    
        $objPHPExcel->getActiveSheet()->mergeCells('A35:F36');
        $objPHPExcel->getActiveSheet()->getStyle('A35:F36')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('A35')->applyFromArray($styleArrayCenterBold); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('G35',  'Performance  Standard/s', PHPExcel_Cell_DataType::TYPE_STRING);                                    
        $objPHPExcel->getActiveSheet()->mergeCells('G35:K36');        
        $objPHPExcel->getActiveSheet()->getStyle('G35:K36')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('G35')->applyFromArray($styleArrayCenterBold); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('L35',  'Action and Support Needed', PHPExcel_Cell_DataType::TYPE_STRING);                                    
        $objPHPExcel->getActiveSheet()->mergeCells('L35:U36');        
        $objPHPExcel->getActiveSheet()->getStyle('L35:U36')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('L35')->applyFromArray($styleArrayCenterBoldTop);   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('V35',  'Timeline', PHPExcel_Cell_DataType::TYPE_STRING);                                    
        $objPHPExcel->getActiveSheet()->mergeCells('V35:Y36');        
        $objPHPExcel->getActiveSheet()->getStyle('V35:Y36')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('V35')->applyFromArray($styleArrayCenterBoldTop); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('Z35',  'Result', PHPExcel_Cell_DataType::TYPE_STRING);                                    
        $objPHPExcel->getActiveSheet()->mergeCells('Z35:AF36');        
        $objPHPExcel->getActiveSheet()->getStyle('Z35:AF36')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('Z35')->applyFromArray($styleArrayCenterBoldTop);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('AG35',  'Rating', PHPExcel_Cell_DataType::TYPE_STRING);                                    
        $objPHPExcel->getActiveSheet()->mergeCells('AG35:AH36');        
        $objPHPExcel->getActiveSheet()->getStyle('AG35:AH36')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('AG35')->applyFromArray($styleArrayCenterBoldTop);   

        $objPHPExcel->getActiveSheet()->getStyle('A35:AH36')->applyFromArray($styleBorder);                                 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B67',  'Conclusion and Final Rating', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B67')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B68',  'Please rate the Performance Improvement Plan overall result based on achievement of identified action plan.', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B69',  'Performance Improvement Plan Rating', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B69')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->mergeCells('AA69:AF69');        
        $objPHPExcel->getActiveSheet()->getStyle('AA69:AF69')->applyFromArray($styleBorder);     
        $objPHPExcel->getActiveSheet()->getStyle('A67:AH69')->applyFromArray($styleBorderOutline);   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B71',  'Comments', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B71')->applyFromArray($styleArray);    
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B72',  'Please use the respective comment field (optional)', PHPExcel_Cell_DataType::TYPE_STRING);                
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B73',  'Employee', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B73')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->mergeCells('F73:AG83'); 
        $objPHPExcel->getActiveSheet()->getStyle('F73:AG83')->applyFromArray($styleBorder);            
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B85',  'Department', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B85')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->mergeCells('F85:AG95'); 
        $objPHPExcel->getActiveSheet()->getStyle('F85:AG95')->applyFromArray($styleBorder);             
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B86',  'Head', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B86')->applyFromArray($styleArray);        
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B97',  'Divison Head', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B97')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->mergeCells('F97:AG107'); 
        $objPHPExcel->getActiveSheet()->getStyle('F97:AG107')->applyFromArray($styleBorder);
        $objPHPExcel->getActiveSheet()->getStyle('A71:AH108')->applyFromArray($styleBorderOutline); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B110',  'Signature', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('B110')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->mergeCells('B111:J111'); 
        $objPHPExcel->getActiveSheet()->getStyle('B111:J111')->applyFromArray($styleBorder);        
        $objPHPExcel->getActiveSheet()->mergeCells('L111:P111'); 
        $objPHPExcel->getActiveSheet()->getStyle('L111:P111')->applyFromArray($styleBorder);          
        $objPHPExcel->getActiveSheet()->mergeCells('S111:AA111'); 
        $objPHPExcel->getActiveSheet()->getStyle('S111:AA111')->applyFromArray($styleBorder);        
        $objPHPExcel->getActiveSheet()->mergeCells('AC111:AG111'); 
        $objPHPExcel->getActiveSheet()->getStyle('AC111:AG111')->applyFromArray($styleBorder);  

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B112',  'Employee', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('L112',  'Date', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('S112',  'Department Head', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('AC112',  'Date', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('B113:J113'); 
        $objPHPExcel->getActiveSheet()->getStyle('B113:J113')->applyFromArray($styleBorder);          
        $objPHPExcel->getActiveSheet()->mergeCells('L113:P113'); 
        $objPHPExcel->getActiveSheet()->getStyle('L113:P113')->applyFromArray($styleBorder); 
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B114',  'Division Head', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('L114',  'Date', PHPExcel_Cell_DataType::TYPE_STRING);  
        $objPHPExcel->getActiveSheet()->getStyle('A110:AH114')->applyFromArray($styleBorderOutline);  
        //$objPHPExcel->getActiveSheet()->getPageSetup()->setPrintArea('A1:AH110,A110:AH110');    
...
/*    $alphabet  = range('A','Z');
    ...
    foreach ($employees_array as $employee_id => $info) {
      ...
      $objPHPExcel->getActiveSheet()->getStyle('A6:'.$xcoor . ($line - 1) .'')->applyFromArray($styleBorder);*/
        ...
        header('Content-Disposition: attachment;filename=Performance_Improvement_Plan_Report_'.date('Y-m-d').'.xls');
