...
class Promotion_form_report extends MY_Controller
{
  ...
  function index()
    ...
    $data['content'] = 'employees/appraisal/reports/promotion_form_report';
  ...
  function export() {
        ...
        $styleArrayCenterBoldVCenter = array(
            'font' => array(
                'bold' => true,
            ),          
            'alignment' => array(
        ...
        $objPHPExcel->getProperties()->setTitle("Promotion Form Report")
                    ->setDescription("Promotion Form Report");
        ...
        for ($i=0; $i < 9; $i++) { 
          ...
          $objPHPExcel->getActiveSheet()->getColumnDimension($xcoor)->setWidth(9);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A1',  'RECOMMENDATION FOR PROMOTION', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A1')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A3',  'Name of Candidate', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A3:B4');   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('C3',  'Department', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('C3:E4');        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F3',  'Division', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('F3:G4');   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('H3',  'Date(mm/dd/yy)', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('H3:I4');  

        $objPHPExcel->getActiveSheet()->getStyle('A3:I4')->applyFromArray($styleArrayBoldTop); 
        $objPHPExcel->getActiveSheet()->getStyle('A3:I4')->applyFromArray($styleBorder);                


        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A5',  'I. Recommended Promotion', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A5')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('C6',  'From', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('C6')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->getStyle('C6')->applyFromArray($styleArrayCenter);
        $objPHPExcel->getActiveSheet()->mergeCells('C6:E6');   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F6',  'To', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('F6')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->getStyle('F6')->applyFromArray($styleArrayCenter);
        $objPHPExcel->getActiveSheet()->mergeCells('F6:G6');           

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('H6',  'Effectivity', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('H6')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->getStyle('H6')->applyFromArray($styleArrayCenter);
        $objPHPExcel->getActiveSheet()->mergeCells('H6:I6');                   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A7',  'Level*', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A7')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet()->mergeCells('A7:B7');                   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A8',  'Position', PHPExcel_Cell_DataType::TYPE_STRING);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('C6:I8')->applyFromArray($styleBorder);                  

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A10',  '*Staff levels:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A11',  'Supervisory/Officer Levels:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A12',  'Managerial levels:', PHPExcel_Cell_DataType::TYPE_STRING);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('E10',  'Level 3 and Level 4', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('E11',  'Level 5, Level 6 and Level 7', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('E12',  'Level 8 and Level 9', PHPExcel_Cell_DataType::TYPE_STRING);        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A14',  'II. Performance History', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A14')->applyFromArray($styleArray);        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A15',  'Consistent performance rating over the last 3 years of at least Effective Contributor or Average/Satisfactory.', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A15:I16');
        $objPHPExcel->getActiveSheet()->getStyle('A15:I16')->getAlignment()->setWrapText(true);   

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A17',  '2015', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A17:A19');
        $objPHPExcel->getActiveSheet()->getStyle('A17:A19')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('A17:A19')->applyFromArray($styleArrayCenterBoldVCenter);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B17',  '2014', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('B17:B19');
        $objPHPExcel->getActiveSheet()->getStyle('B17:B19')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('B17:B19')->applyFromArray($styleArrayCenterBoldVCenter);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('C17',  '2013', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('C17:C19');
        $objPHPExcel->getActiveSheet()->getStyle('C17:C19')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('C17:C19')->applyFromArray($styleArrayCenterBoldVCenter);        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('D17',  'Date of Last Promotion', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('D17:D19');
        $objPHPExcel->getActiveSheet()->getStyle('D17:D19')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('D17:D19')->applyFromArray($styleArrayCenterBoldVCenter);        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('E17',  'Service yrs. In Level', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('E17:E19');
        $objPHPExcel->getActiveSheet()->getStyle('E17:E19')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('E17:E19')->applyFromArray($styleArrayCenterBoldVCenter);                

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F17',  'Remarks ', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('F17:I19');
        $objPHPExcel->getActiveSheet()->getStyle('F17:I19')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('F17:I19')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('A17:I20')->applyFromArray($styleBorder);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A22',  'III. Achievement and Scope', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A22')->applyFromArray($styleArray); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A24',  'No. of Direct Reports ( if applicable )', PHPExcel_Cell_DataType::TYPE_STRING);          
        $objPHPExcel->getActiveSheet()->mergeCells('A24:A28');
        $objPHPExcel->getActiveSheet()->getStyle('A24:A28')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('A24:A28')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('A24:A28')->applyFromArray($styleBorder);    

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B24',  'Accomplishments /Projects for the past 3 years', PHPExcel_Cell_DataType::TYPE_STRING);          
        $objPHPExcel->getActiveSheet()->mergeCells('B24:E28');
        $objPHPExcel->getActiveSheet()->getStyle('B24:E28')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('B24:E28')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('B24:E28')->applyFromArray($styleBorder);  

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F24',  'CAPEX Managed (if applicable)', PHPExcel_Cell_DataType::TYPE_STRING);          
        $objPHPExcel->getActiveSheet()->mergeCells('F24:F28');
        $objPHPExcel->getActiveSheet()->getStyle('F24:F28')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('F24:F28')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('F24:F28')->applyFromArray($styleBorder);                        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('G24',  'Revenue Generated (if applicable)', PHPExcel_Cell_DataType::TYPE_STRING);          
        $objPHPExcel->getActiveSheet()->mergeCells('G24:G28');
        $objPHPExcel->getActiveSheet()->getStyle('G24:G28')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('G24:G28')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('G24:G28')->applyFromArray($styleBorder);                                

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('H24',  'NIAT Results (if applicable)', PHPExcel_Cell_DataType::TYPE_STRING);          
        $objPHPExcel->getActiveSheet()->mergeCells('H24:H28');
        $objPHPExcel->getActiveSheet()->getStyle('H24:H28')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('H24:H28')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('H24:H28')->applyFromArray($styleBorder);                                        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('I24',  'GLA (if applicable)', PHPExcel_Cell_DataType::TYPE_STRING);          
        $objPHPExcel->getActiveSheet()->mergeCells('I24:I28');
        $objPHPExcel->getActiveSheet()->getStyle('I24:I28')->getAlignment()->setWrapText(true);  
        $objPHPExcel->getActiveSheet()->getStyle('I24:I28')->applyFromArray($styleArrayCenterBoldVCenter); 
        $objPHPExcel->getActiveSheet()->getStyle('I24:I28')->applyFromArray($styleBorder);

        $objPHPExcel->getActiveSheet()->mergeCells('A29:A49');        
        $objPHPExcel->getActiveSheet()->mergeCells('B29:E49');
        $objPHPExcel->getActiveSheet()->mergeCells('F29:F49');
        $objPHPExcel->getActiveSheet()->mergeCells('G29:G49');
        $objPHPExcel->getActiveSheet()->mergeCells('H29:H49');
        $objPHPExcel->getActiveSheet()->mergeCells('I29:I49');       
        $objPHPExcel->getActiveSheet()->getStyle('A29:I49')->applyFromArray($styleBorder);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A51',  'III. Potential', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->getStyle('A51')->applyFromArray($styleArray);         
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A52',  'Candidate should have demonstrated competencies for the next level via:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B53',  '1. Assumption of an expanded job scope for at least 6 months', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B54',  '2. Satisfactory performance in the expanded job scope', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A56',  'A. Describe how the candidate\'s responsibilities have expanded from last promotion.', PHPExcel_Cell_DataType::TYPE_STRING);

        $objPHPExcel->getActiveSheet()->mergeCells('A58:I67');       
        $objPHPExcel->getActiveSheet()->getStyle('A58:I67')->applyFromArray($styleBorder);        

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A69',  'B. What are the top 2 to 3 competencies for the expanded role? Please describe how the  candidate demonstrated these competencies.', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A69:I70');
        $objPHPExcel->getActiveSheet()->getStyle('A69:I70')->getAlignment()->setWrapText(true); 

        $objPHPExcel->getActiveSheet()->mergeCells('A72:I81');       
        $objPHPExcel->getActiveSheet()->getStyle('A72:I81')->applyFromArray($styleBorder);         

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A83',  'Recommended By:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A83:C83');
        $objPHPExcel->getActiveSheet()->getStyle('A83')->applyFromArray($styleArray);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('D83',  'Approved By:', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('D83:I83');
        $objPHPExcel->getActiveSheet()->getStyle('D83')->applyFromArray($styleArray); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A84',  'Name & Signature Date', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('A84:C85');       
        $objPHPExcel->getActiveSheet()->getStyle('A84:C85')->applyFromArray($styleBorder);               
        $objPHPExcel->getActiveSheet()->getStyle('A84:C85')->applyFromArray($styleArrayBottom); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('D84',  'Division Head Signature & Date', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('D84:E85');       
        $objPHPExcel->getActiveSheet()->getStyle('D84:E85')->applyFromArray($styleBorder);               
        $objPHPExcel->getActiveSheet()->getStyle('D84:E85')->applyFromArray($styleArrayBottom); 

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F84',  'HRD Head Signature & Date', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('F84:G85');       
        $objPHPExcel->getActiveSheet()->getStyle('F84:G85')->applyFromArray($styleBorder);               
        $objPHPExcel->getActiveSheet()->getStyle('F84:G85')->applyFromArray($styleArrayBottom);    

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('H84',  'CEO/President Signature Date', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('H84:I85');       
        $objPHPExcel->getActiveSheet()->getStyle('H84:I85')->applyFromArray($styleBorder);               
        $objPHPExcel->getActiveSheet()->getStyle('H84:I85')->applyFromArray($styleArrayBottom);                        
        // column header.
/*    $alphabet  = range('A','Z');
    $alpha_ctr = 0;
    $sub_ctr   = 0;
    ...
    foreach ($employees_array as $employee_id => $info) {
      ...
      $objPHPExcel->getActiveSheet()->getStyle('A6:'.$xcoor . ($line - 1) .'')->applyFromArray($styleBorder);*/
        ...
        header('Content-Disposition: attachment;filename=Promotion_Form_Report'.date('Y-m-d').'.xls');
