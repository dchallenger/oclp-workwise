...
class Sub_committee_worksheet extends MY_Controller
{
    ...
    { 	
		...
		$data['content'] = 'employees/appraisal/reports/sub_committee_worksheet';
	...
	function export() {
        ...
        $objPHPExcel->getProperties()->setTitle("Sub Committee Worksheet Report")
                    ->setDescription("Sub Committee Worksheet");
        ...
        $objPHPExcel->getActiveSheet()->getDefaultColumnDimension('C')->setWidth(15);
        $objPHPExcel->getActiveSheet()->getDefaultColumnDimension('D')->setWidth(15);
        $objPHPExcel->getActiveSheet()->getDefaultColumnDimension('E')->setWidth(15);
        $objPHPExcel->getActiveSheet()->getDefaultColumnDimension('F')->setWidth(15);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A1',  'Sub Committee Worksheet', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A2',  'Perf. Rating and Promotion Overview', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->setCellValueExplicit('A4',  'A. Rating Overview', PHPExcel_Cell_DataType::TYPE_STRING);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('B7',  'Guideline', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('B7:C7');
        $objPHPExcel->getActiveSheet()->getStyle('B7:C7')->applyFromArray($styleArrayCenter);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('D7',  'Actual', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('D7:E7');   
        $objPHPExcel->getActiveSheet()->getStyle('D7:E7')->applyFromArray($styleArrayCenter);

        $objPHPExcel->getActiveSheet()->setCellValueExplicit('F7',  'Variance (Guideline less Actual)', PHPExcel_Cell_DataType::TYPE_STRING);
        $objPHPExcel->getActiveSheet()->mergeCells('F7:G7');               
        $objPHPExcel->getActiveSheet()->getStyle('F7:G7')->applyFromArray($styleArrayCenter);

        /**********************************************************************************************************************/
		$guideline  = array('1-3' => 1,'4' => 3, '5' => 1);
		$guideline_percentage  = array('1-3' => 20,'4' => 60, '5' => 20);
		...
		$employee_query = "SELECT 
							SUM(CASE WHEN final_rating BETWEEN 1 AND 3 THEN 1 ELSE 0 END) AS level1,
							SUM(CASE WHEN final_rating = 4 THEN 1 ELSE 0 END) AS level2,
							SUM(CASE WHEN final_rating = 5 THEN 1 ELSE 0 END) AS level3
							FROM hr_employee_appraisal_bsc eab
							WHERE eab.deleted = 0";
		...
		if ($employee_result && $employee_result->num_rows() > 0) {
			$level_rate = $employee_result->row_array();

			$objPHPExcel->getActiveSheet()->setCellValueExplicit('E9',  $level_rate['level1'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
			$objPHPExcel->getActiveSheet()->setCellValueExplicit('E10',  $level_rate['level2'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
			$objPHPExcel->getActiveSheet()->setCellValueExplicit('E11',  $level_rate['level3'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
			$objPHPExcel->getActiveSheet()->setCellValueExplicit('E12',  array_sum($level_rate), PHPExcel_Cell_DataType::TYPE_NUMERIC);
		}

		$actual_percentage_level1 = (($level_rate['level1'] / array_sum($guideline)) * 10);
		$actual_percentage_level2 = (($level_rate['level2'] / array_sum($guideline)) * 10);
		$actual_percentage_level3 = (($level_rate['level3'] / array_sum($guideline)) * 10);
		$actual_percentage_level_total = $actual_percentage_level1 + $actual_percentage_level2 + $actual_percentage_level3;

		$variance_percentage_level1 = $guideline_percentage['1-3'] - $actual_percentage_level1;
		$variance_percentage_level2 = $guideline_percentage['4'] - $actual_percentage_level2;
		$variance_percentage_level3 = $guideline_percentage['5'] - $actual_percentage_level3;
		$variance_percentage_level_total = $variance_percentage_level1 + $variance_percentage_level2 + $variance_percentage_level3;

		$variance_level1 = $guideline['1-3'] - $level_rate['level1'];
		$variance_level2 = $guideline['4'] - $level_rate['level2'];
		$variance_level3 = $guideline['5'] - $level_rate['level3'];
		$variance_level_total = $variance_level1 + $variance_level2 + $variance_level3;

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A8',  'Ratings', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B8',  '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C8',  'No.', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('D8',  '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E8',  'No.', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('F8',  '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('G8',  'No.', PHPExcel_Cell_DataType::TYPE_STRING);				

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A9',  '1-3', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B9',  $guideline_percentage['1-3'].'%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C9',  $guideline['1-3'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('D9',  $actual_percentage_level1 . '%', PHPExcel_Cell_DataType::TYPE_STRING);
/*		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E9',  '3', PHPExcel_Cell_DataType::TYPE_NUMERIC);*/
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('F9',  $variance_percentage_level1 . '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('G9',  $variance_level1, PHPExcel_Cell_DataType::TYPE_NUMERIC);	

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A10',  '4', PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B10',  $guideline_percentage['4'].'%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C10',  $guideline['4'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('D10',  $actual_percentage_level2 . '%', PHPExcel_Cell_DataType::TYPE_STRING);
/*		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E10',  '2', PHPExcel_Cell_DataType::TYPE_NUMERIC);*/
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('F10',  $variance_percentage_level3 . '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('G10',  $variance_level2, PHPExcel_Cell_DataType::TYPE_NUMERIC);			

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A11',  '5', PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B11',  $guideline_percentage['5'].'%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C11',  $guideline['5'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('D11',  $actual_percentage_level3 . '%', PHPExcel_Cell_DataType::TYPE_STRING);
/*		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E11',  '0', PHPExcel_Cell_DataType::TYPE_NUMERIC);*/
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('F11',  $variance_percentage_level3 . '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('G11',  $variance_level1, PHPExcel_Cell_DataType::TYPE_NUMERIC);	

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A12',  'Total', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B12',  array_sum($guideline_percentage).'%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C12',  array_sum($guideline), PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('D12',  $actual_percentage_level_total . '%', PHPExcel_Cell_DataType::TYPE_STRING);
/*		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E12',  '5', PHPExcel_Cell_DataType::TYPE_NUMERIC);*/
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('F12',  $variance_percentage_level_total . '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('G12',  $variance_level_total, PHPExcel_Cell_DataType::TYPE_NUMERIC);	


		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A19',  'B. Promotion Overview', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A20',  'Total Employees:', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B20',  '1', PHPExcel_Cell_DataType::TYPE_NUMERIC);
		$objPHPExcel->getActiveSheet()->getStyle('B20')->applyFromArray($styleArrayCenter);

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B22',  '%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C22',  'No. of Emp.', PHPExcel_Cell_DataType::TYPE_STRING);

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A23',  'Guideline', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B23',  '12%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C23',  '1', PHPExcel_Cell_DataType::TYPE_NUMERIC);

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A24',  'Actual', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B24',  '40%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C24',  '2', PHPExcel_Cell_DataType::TYPE_NUMERIC);

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('A25',  'Variance', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('B25',  '-28%', PHPExcel_Cell_DataType::TYPE_STRING);
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('C25',  '-1', PHPExcel_Cell_DataType::TYPE_NUMERIC);	

		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E19',  'C. Approvals:', PHPExcel_Cell_DataType::TYPE_STRING);		
		$objPHPExcel->getActiveSheet()->getStyle('E23:G23')->applyFromArray($styleBorderOnly);
		$objPHPExcel->getActiveSheet()->mergeCells('E23:G23');
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E24',  'Division Head Name/Date', PHPExcel_Cell_DataType::TYPE_STRING);		

		$objPHPExcel->getActiveSheet()->getStyle('E28:G28')->applyFromArray($styleBorderOnly);
		$objPHPExcel->getActiveSheet()->mergeCells('E28:G28');
		$objPHPExcel->getActiveSheet()->setCellValueExplicit('E29',  'HR Head Name/Date', PHPExcel_Cell_DataType::TYPE_STRING);				

		$objPHPExcel->getActiveSheet()->getStyle('A22:C25')->applyFromArray($styleArrayCenter);

		$objPHPExcel->getActiveSheet()->getStyle('A7:G12')->applyFromArray($styleBorder);
		$objPHPExcel->getActiveSheet()->getStyle('A22:C25')->applyFromArray($styleBorder);

		$objPHPExcel->getActiveSheet()->getStyle('A1:A4')->applyFromArray($styleArray);
		$objPHPExcel->getActiveSheet()->getStyle('B7:G7')->applyFromArray($styleArray);
		...
		$objPHPExcel->getActiveSheet()->getStyle('E19')->applyFromArray($styleArray);
...
/*        $line = 7;	
        ...
        header('Content-Disposition: attachment;filename=Sub_Committee_Worksheet_'.date('Y-m-d').'.xls');
