...
class Suggestion_box extends MY_Controller
{
	function __construct()
    {
		...
		if( !($this->is_admin || $this->is_superadmin || $this->user_access[$this->module_id]['post']) ){
			$this->filter = $this->db->dbprefix.$this->module_table.'.employee_id = ' . $this->user->user_id;
		}		
    }
	...
	{
		$this->listview_qry .= ',CONCAT (firstname," ",lastname) as name';
	}	
