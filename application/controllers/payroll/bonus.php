...
class Bonus extends MY_Controller
{
	...
	function index(){
        ...
        $tabs[] = '<li class="active"><a href="javascript:void(0)">Bonuses</li>';
	...
	function ajax_save(){
		...
		$this->db->delete('payroll_bonus_employee', array( $this->key_field => $this->key_field_val ));
		...
		foreach( $employees as $index => $employee_id ){
			...
			$this->db->insert( 'payroll_bonus_employee', $data );
		}
	}
