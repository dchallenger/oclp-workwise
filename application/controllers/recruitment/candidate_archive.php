...
class Candidate_archive extends MY_Controller
{
	function __construct()
    {
		...
		$this->filter = $this->db->dbprefix . 'recruitment_manpower_candidate.candidate_status_id IN (6)';
	...
	function index()
    {
        ...
        $tabs[] = '<li filter="archive" class="active"><a href="'.base_url().'recruitment/candidate_archive">Archive <span id="postedjobs-counter" class="bg-orange ctr-inline">'.$array_tab_count['archive'].'</span></li>';
