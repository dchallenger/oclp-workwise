...
<? else : ?>
                                ...
                                if (isset($fieldgroup['fields']) && sizeof($fieldgroup['fields']) > 0) :
                                    foreach ($fieldgroup['fields'] as $field) :
                                        ...
                                        if ( (!$this->is_admin && !$this->superadmin) 
                                            ...
                                            if( $_POST['filter'] == "personal" || $_POST['filter'] == "for_approval") $field['value'] = $this->userinfo['user_id'];
                                            
                                            if ( !$this->user->is_supervisor && !$this->user->is_srmanager && !$this->user->is_jrmanager ) {
                                                echo form_hidden('employee_flag', 1);
                                            }
                                        }
                                        ...
                                        if ($field['column'] == 'label-dates-affected' && isset($dates_affected)) {
                                            $shifts = array(1 => 'Whole day', 2 => 'First Half Shift', 3 => 'Second Half of Shift');
        ...
        if ($chosen_autocomplete) die("DWDW");
            echo chosen_script();        
