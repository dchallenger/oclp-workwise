...
<form id="comment-form" method="post">
	...
	<div class="icon-label-group align-center">
	        <div class="icon-label"> <a href="javascript:void(0);" onclick="save_comment();" class="icon-16-add " id="boxy-save-comment"> <span>Add Comment</span> </a> </div>
	        <div class="icon-label"> <a href="javascript:void(0);" class="icon-16-close"> <span>Close</span> </a> </div>	    
	</div>	
	</div>
