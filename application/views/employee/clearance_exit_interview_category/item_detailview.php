            ...
            <div>
                <div class="form-item view odd">
                    ...
                    <div class="text-input-wrap">
                    	<?= $data['clearance_exit_interview_item_no'] ?>
                    </div>
                </div>
                <div class="form-item view even">
                    ...
                    <div class="text-input-wrap">
                    	<?= $data['clearance_exit_interview_item'] ?>
                    </div>
                </div>
                <div class="form-item view odd">
                    ...
                    <div class="text-input-wrap">
                    	<?php 
                            $item_score_type = $data['exit_interview_score_type_id'];
                            foreach( $item_score_type_list as $item_score_type_info ){ ?>
                                <?php if( $item_score_type_info['score_type_id'] == $item_score_type ){ echo $item_score_type_info['exit_interview_score_type']; } ?>
                        <?php } ?>
                    </div>
                </div>
