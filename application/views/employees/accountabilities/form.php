...
<div class="form-multiple-add" style="display: block;">
    ...
    <div class="form-item even">
        ...
        <div class="text-input-wrap">
            <input type="text" readonly="readonly" class="input-text datepicker date" value="<?= ($data['date_issued'] == "0000-00-00" || $data['date_issued'] == "1970-01-01" || $data['date_issued'] == "" ? "" : date('m/d/Y', strtotime($data['date_issued']))) ?>" name="accountabilities[date_issued][]" /> <span></span>
        </div>
    </div>                
    <div class="form-item even">
        ...
        <div class="text-input-wrap">
            <input type="text" readonly="readonly" class="input-text datepicker date" value="<?= ($data['date_returned'] == "0000-00-00" || $data['date_returned'] == "1970-01-01" || $data['date_issued'] == "" ? "" : date('m/d/Y', strtotime($data['date_returned']))) ?>" name="accountabilities[date_returned][]" /> <span></span>
        </div>
    </div>                 
    <div class="form-item odd">
...
<!--         <div class="select-input-wrap">  
            <select name="accountabilities[employee_clearance_form_checklist_id][]" id="clearance_approver">
            </select>                      
        </div> -->
    </div>      
    <div class="form-item odd">
