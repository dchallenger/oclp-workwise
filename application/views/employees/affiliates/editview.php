                 ...
                 <div class="form-multiple-add" style="display: block;">
                    ...
                    <div class="form-item odd">
                        ...
                        <div class="text-input-wrap">
                            <input type="text" class="input-text" value="<?= $data['name'] ?>" name="affiliates[name][]">
                        </div>
                    </div>
                     ...
                     <div class="form-item even">
                        ...
                        <div class="text-input-wrap">
                         <?php if($data['date_resigned'] != "0000-00-00"){  ?>
                          ...
                          <?php  }else{  ?>
                            <input type="text" class="input-text" readonly="readonly" style="width:30%;" name="affiliates[date_resigned][]" id="affiliates_date_resigned" />
                            <img class="ui-datepicker-trigger datebutton" src="<?php echo base_url(); ?>themes/slategray/icons/calendar-month.png" alt="" title="">
                          <?php } ?>
                        </div>
                    </div>
                    <div class="form-item odd">
