...
<? endif; ?>
                    ...
                    $("#jqgridcontainer").jqGrid('setGroupHeaders', {
                          ...
                          groupHeaders:[
                            {startColumnName: 'range_of_rank', numberOfColumns: 1, titleText: '<span style="font-weight:bold;">Range of</span>'},
                            {startColumnName: 'years', numberOfColumns: 2, titleText: '<span style="font-weight:bold;">Tenure</span>'},
                            {startColumnName: 'regularized', numberOfColumns: 1, titleText: '<span style="font-weight:bold;">Date</span>'},
                            {startColumnName: 'prev_annual_pa_rating', numberOfColumns: 1, titleText: '<span style="font-weight:bold;" id="annual1"><?php echo date("Y")?></span>'},
                            {startColumnName: 'prev_prev_annual_pa_rating', numberOfColumns: 1, titleText: '<span style="font-weight:bold;" id="annual2"><?php echo date("Y")?></span>'}
                          ]
                    }).trigger("reloadGrid");
