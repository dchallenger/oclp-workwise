<fieldset>
<?php if ($this->module_link == 'employee/employee_update'): ?>    
    <div class="icon-label-group align-left">
        <div style="" class="icon-label add-more-div">
            <a href="javascript:void(0);" class="icon-16-add icon-16-add-listview add-more-eu" rel="attachment"><span>Add</span></a>
        </div>
    </div>
    <div class="clear"></div>  
<? endif; ?>    
