...
?>
<table width="70%" cellspacing="10" cellpadding="10" class="balance">
    <thead height="25px" align="center">
            <td width="20%">&nbsp;</td>
            <td style="<?=$css?>"width="15%">VL</td>
            <td style="<?=$css?>"width="15%">SL</td>
            <td style="<?=$css.$visibility?>"width="15%">EL</td>
            <?php 

            if( $record_id == "-1" ){
                 if( $this->userinfo['sex'] == 'male' ){ ?>
                <td style="<?=$css?>"width="15%" id="mpl_header">PL</td>
            <?php }else{ ?>
                <?php if( $this->config->item('client_no') != 2 ){ ?>
                    <td style="<?=$css?>"width="15%" id="mpl_header">ML</td>
                <?php } ?>
            <?php }
            }else{
            ...
            ?>
<!--             <td style="<?=$css?>"width="15%">BL</td> -->
    </thead>
    <tr height="20px" align="center">
            <td style="<?=$css?>">Credits</td>
            <td style="<?=$css?>" id="vl"></td>
            <td style="<?=$css?>" id="sl"></td>
            <td style="<?=$css.$visibility?>" id="el"></td>
            <?php if( $record_id == "-1" ){ ?>
                <?php 
...
<!--             <td style="<?=$css?>" id="bl"><?=(isset($balance)) ? $balance->bl : ''?></td> -->
    </tr>
    <tr height="20px" align="center">
...
<!--             <td style="<?=$css?>" id="bl_used"><?=(isset($balance)) ? $balance->bl_used : ''?></td> -->
    </tr>
    <tr height="20px" align="center">
            <td style="<?=$css?>">Balance</td>
            <td style="<?=$css?>" id="vl_balance"></td>
            <td style="<?=$css?>" id="sl_balance"></td>
            <td style="<?=$css.$visibility?>" id="el_balance"></td>
...
<!--             <td style="<?=$css?>" id="bl_balance"><?=(isset($balance)) ? $balance->bl - $balance->bl_used: ''?></td> -->
    </tr>
</table>
