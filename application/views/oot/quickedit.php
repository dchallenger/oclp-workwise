    ...
    <div class="form-submit-btn">
        ...
        <div class="icon-label-group">
        	...
        	<?php if($this->user_access[$this->module_id]['cancel'] == 1 && $this->input->post('record_id') != '-1'):
		      $show_or = true;?>
		          <div class="icon-label">
		              <a class="icon-16-cancel" href="javascript:void(0);" onclick="change_oot_status(<?php echo $this->input->post('record_id')?>, 5)">
		                  <span>Cancel</span>
		              </a>            
		          </div>
		    <?php endif; ?>
        ...
        <div class="or-cancel">
            ...
            <a class="cancel" href="javascript:void(0)" onclick="quickedit_boxy.hide().unload()">Close</a>
        </div>
    </div>
</form>
 <div class="clear"></div>
