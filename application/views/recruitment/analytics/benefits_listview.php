          ...
          <div id="form-div">
            <div class="col-2-form"> 
                ...
                <div class="form-item odd ">
                    <label class="label-desc gray" for="category">Category:</label>
                ...
                <div class="form-item even hide ">
                    <label class="label-desc gray" for="company">Previous Company:</label>
                    <div class="multiselect-input-wrap">
                        <select multiple="multiple" class="multi-select multi-select-company" name="company[]" id="company">
                            <?php
                ...
                <div class="form-item even hide ">
                    <label class="label-desc gray" for="benefit">Benefits:</label>
                    <div class="multiselect-input-wrap">
                        <select multiple="multiple" class="multi-select multi-select-benefit" name="benefit[]" id="benefit">
                            <?php
