       ...
       <form id="export-form" method="post" action="">
          ...
          <div id="form-div">
            <div class="col-2-form"> 
                ...
                <div class="form-item odd ">
                    <label class="label-desc gray" for="level">Level:</label>
                    <div class="multiselect-input-wrap">
                        <select multiple="multiple" class="multi-select" name="level[]" id="level">
                            <?php
                                foreach($levels as $level){ ?>
                                <option value="<?=$level['job_rank_id'] ?>"><?=$level['job_rank'] ?></option>
                            <?php } ?>
                        </select>
                    </div>              
                </div> 
