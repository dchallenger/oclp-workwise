<?php $module_link = $this->module_link;
    $shrinktofit = 'true';

    if ($module_link == 'recruitment/fill_rate') {
         $shrinktofit = 'false';
    }
...
<? endif; ?>
                    ...
                    $("#jqgridcontainer").jqGrid('setGroupHeaders', {
                          ...
                          groupHeaders:[
                            {startColumnName: 'actual', numberOfColumns: 2, titleText: '<span style="font-weight:bold;">Headcount</span>'},
                            {startColumnName: 'as_of', numberOfColumns: 1, titleText: '<span style="font-weight:bold;">As of</span> <span id="last-year" style="font-weight:bold;">'+<?=date('Y')-1?>+'</span>'}
                          ]
                    }).trigger("reloadGrid");
