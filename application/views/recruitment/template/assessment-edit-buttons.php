...
<div class="icon-label-group ">
    <span class="<?php echo ($record_id < 0) ? 'form-submit-btn' : '' ?> <?php echo $show_wizard_control && isset($fieldgroups) && sizeof($fieldgroups) > 1 && $record_id < 0 ? 'hidden' : '' ?>">
    	<div class="icon-label"> <a class="icon-16-next endorse" href="javascript:void(0);" tooltip="This button will forward current application to for Background Check status"><span>Endorse For Background Check</span></a> </div>
