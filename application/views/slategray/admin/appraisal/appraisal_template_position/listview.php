...
?>
	...
	<form name="record-form" id="record-form" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="employee_appraisal_template_company_id" id="employee_appraisal_template_company_id" value="<?php echo $employee_appraisal_template_company_id ?>"/>
