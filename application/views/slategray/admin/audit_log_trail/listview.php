...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('leave/incomplete_attendance_report/export')?>" />
          <input type="hidden" name="previous_page" id="previous_page" value="<?=base_url().$this->module_link?>/detail"/>        
          <div id="form-div">
            <div class="col-2-form">
              <div class="form-item odd ">
                <label class="label-desc gray" for="user">User:</label>
                <div class="multiselect-input-wrap">
                    <select multiple="multiple" class="multi-select" style="width:400px;" name="user[]" id="user">
                        <?php
              ...
              <div class="form-item even ">
                <label class="label-desc gray" for="date_period">Date:<span class="red font-large">*</span></label>
