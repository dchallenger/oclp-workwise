    ...
    <? else :?>
            ...
            <form class="style2 detail-view" name="record-form" id="record-form" method="post" enctype="multipart/form-data">
            	<input type="hidden" name="previous_page" id="previous_page" value="<?=base_url().$this->module_link?>"/>             
							<h3 class="form-head">Employee 201 Settings</h3>
                <div class="col-2-form view">                    
                    <div class="form-item view odd">
                        <label for="company_code" class="label-desc view gray">Enable Edit 201:</label>
                        <div class="text-input-wrap">
                        <?php
                            if(isset( $edit_201_settings['enable_edit'] ) && $edit_201_settings['enable_edit'] == 1 ){
                                    echo 'Yes';
                            }
                            else{
                                    echo 'No';
                    ...
                    <div class="form-item view even">
                        ...
                        <div class="text-input-wrap">
                            <?php echo $edit_201_settings['date_from']; ?>
                        </div>
                    </div>
                    ...
                    <div class="form-item view even">
                        ...
                        <div class="text-input-wrap">
                            <?php echo $edit_201_settings['date_to']; ?>
                        </div>
                    </div>
                </div>
