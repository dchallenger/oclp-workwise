    ...
    <?	else :?>
            ...
            <form class="style2 edit-view" name="record-form" id="record-form" method="post" enctype="multipart/form-data">
                ...
                <div class="col-2-form">                    
                    ...
                    <div class="clear"></div>
                    <div class="form-item odd">
                        <label for="use_logo" class="label-desc gray">Use Logo:</label>
                        <div class="radio-input-wrap">
                            <?=form_radio('use_logo', 1, ($meta_raw['use_logo'] == 1), 'class="input-radio"' );?>
                            <label for="use_logo" class="check-radio-label gray">Yes</label>
                            <?=form_radio('use_logo', 0, ($meta_raw['use_logo'] == 0), 'class="input-radio"' );?>
                            <label for="use_logo" class="check-radio-label gray">No</label>                            
                        </div>
                        <p class="form-item-description">(Use the logo instead of title for the header.)</p>
                    </div>                    
                ...
                <div class="col-2-form">                    
                    ...
                    <div class="clear"></div>
                    <div class="form-item odd">
                       <label for="role_settings_dir" class="label-desc gray">Role Settings: <span class="red font-large">*</span></label>
                       <div class="text-input-wrap">
                           <input type="text" name="role_settings_dir" id="role_settings_dir" value="<?=$app_directories['role_settings_dir']?>" class="input-text">
                        </div>
                    </div>
                </div>
