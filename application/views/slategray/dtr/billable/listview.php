...
?>
    ...
    <?  else :?>
       ...
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('dtr/billable_hours_calls/export')?>" />
                ...
                <div class="form-item odd ">
                    ...
                    <div class="multiselect-input-wrap">
                        <select id="campaign" style="width:400px;" name="campaign">
                            <?php
                                $campaign = $this->db->get('campaign')->result();
                                //$category = array("0"=>"Select","1"=>"By Company","2"=>"By Division","3"=>"By Department","4"=>"By Employee");
                                foreach($campaign as $campaign_val){ ?>
                                <option value="<?php echo $campaign_val->campaign_id ?>"><?php echo $campaign_val->campaign ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
    ...
    <!-- echo $this->load->view($this->userinfo['rtheme'] . '/' . $jqgrid);  -->
    <div class="clear"></div>
