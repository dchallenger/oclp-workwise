            ...
            <table id="listview-list" class="default-table boxtype" style="width:100%">
                ...
                <tbody id="listview-tbody">
                    <tr class="odd">
                        ...
                        <td align="center" rowspan="2" style="vertical-align:middle;"><?php echo $balance->vl?></td>
                        <td align="center"><?php echo $balance->vl_used?></td>
                        <td align="center" rowspan="2" style="vertical-align:middle;"><?php echo number_format($balance->vl - ($balance->vl_used+$balance->el_used),2,'.',',')?></td>
                    </tr>
                    <tr class="odd">
                    ...
                    <tr  class="even">
                        ...
                        <td align="center"><?php echo $balance->sl- $balance->sl_used?></td>
                    </tr>
