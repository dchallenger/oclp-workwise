...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('dtr/leave_balance_report/export')?>" />
          ...
          <div id="form-div">
                ...
                <div class="col-2-form"> 
                  ...
                  <div class="form-item odd ">
                    ...
                    <div class="multiselect-input-wrap" id="multi-select-container">
                        <select id="leave_type" style="width:400px;" multiple="multiple" name="leave_type[]">
                        <?php
                  ...
                  <div class="form-item even">
                        <label class="label-desc gray" for="employment_status" id="category_selected">Employment Status:</label>
                        <div class="multiselect-input-wrap">
                            <select multiple="multiple" class="multi-select" style="width:400px;" name="employment_status[]" id="employment_status">
                                <?php
                                    foreach($employment_status as $field){ ?>
                                    <option value="<?php echo $field['employment_status_id'] ?>"><?php echo $field['employment_status'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
