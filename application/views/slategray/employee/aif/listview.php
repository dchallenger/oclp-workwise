...
?>
    ...
    <?  else :?>
       ...
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/aif/export')?>" />
          <input type="hidden" name="previous_page" id="previous_page" value="<?=base_url().$this->module_link?>/detail"/>        
          <input type="hidden" name="export_employee_id" id="export_employee_id" value="" />
          <div id="form-div">
                ...
                <div class="form-item odd ">
                    ...
                    <div class="multiselect-input-wrap">
                        <select id="employee" multiple="multiple" class="multi-select" style="width:400px;" name="employee[]">
                            <?php foreach($employee as $employee_list_record){ ?>
                                    <option value="<?php echo $employee_list_record['employee_id']; ?>"><?php echo $employee_list_record['firstname']." ".$employee_list_record['lastname']; ?></option>
                                <?php } ?>
                        </select>
                    </div>
                </div>
                  ...
                  <div class="form-item even">
                    <label class="label-desc gray" for="with_aif" id="category_selected">With AIF:</label>
                    <div class="radio-input-wrap">
                        <input type="radio" class="input-radio" value="1" id="with_aif_yes" name="with_aif">
                        <label class="check-radio-label gray" for="with_aif_yes">Yes</label>
                        <input type="radio" class="input-radio" value="0" id="with_aif_no" name="with_aif">
                        <label class="check-radio-label gray" for="with_aif_no">No</label>
                        <input type="hidden" name="with_aif_hidden"  id="with_aif_hidden" value="" />
                    </div>
                  </div> 
