...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/dtr_details/export')?>" />
          <input type="hidden" name="previous_page" id="previous_page" value="<?=base_url().$this->module_link?>/detail"/>        
          <div id="form-div">
            <?php if ($w_subordinates > 0): ?> 
                <div class="col-2-form"> 
                  <div class="form-item odd ">
                    ...
                    <div class="multiselect-input-wrap">
                        <select id="category" style="width:400px;" name="category">
                            <?php
                                $category = array("0"=>"Select","1"=>"By Company","2"=>"By Division","3"=>"By Department","4"=>"By Employee","5"=>"By Project");
                  ...
                  <div class="form-item even " id="multi-select-main-container">
                    <label class="label-desc gray" for="department" id="category_selected">Type</label>
                    <div class="multiselect-input-wrap" id="multi-select-container">
                        <select id="category1" style="width:400px;" name="category1">
                            <?php
                                $category1 = array("1"=>"All","2"=>"Hours Worked","3"=>"Absent","8"=>"Excused Tardiness","4"=>"Lates","5"=>"Undertime","6"=>"Overtime", '7' => 'AWOL');
            ...
            <?php else: ?>
                <div class="col-2-form">
                  <div class="form-item odd" id="multi-select-main-container">
                    <label class="label-desc gray" for="department" id="category_selected">Type</label>
                    <div class="multiselect-input-wrap" id="multi-select-container">
                        <select id="category1" style="width:400px;" name="category1">
                            <?php
                                $category1 = array("1"=>"All","2"=>"Hours Worked","3"=>"Absent","8"=>"Excused Tardiness","4"=>"Lates","5"=>"Undertime","6"=>"Overtime");
                                foreach($category1 as $key => $val){ ?>
                                <option value="<?php echo $key ?>"><?php echo $val ?></option>
                            <?php } ?>
                        </select>                  
