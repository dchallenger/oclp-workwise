...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="" />
    ...
    <div class="form-submit-btn">
            <div class="icon-label-group">
                ...
                <div class='icon-label'><a class='icon-16-export module-export_2' container='".$container."' module_link='".$module_link."' href='javascript:void(0)'><span>Export</span></a></div>
            </div>
    </div>  
