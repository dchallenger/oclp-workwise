<div class="icon-label-group">
    <div class="icon-label">
          <a rel="save-draft" class="icon-16-disk" href="javascript:void(0);" onclick="draft_ir('back', <?php echo $show_wizard_control ? 1 : 0 ?>)">
  ...
  <?php endif?>
    <?php if( ($this->user_access[$this->module_id]['add'] == 1) && ( $this->user_access[$this->module_id]['approve'] != 1 ) && ( $ir_status_id == 1 || $ir_status_id == -1 ) ){ ?>
      <div class="icon-label">
...
<script>
  ...
  <?php endif?>
    ...
    function draft_ir( on_success, is_wizard , callback ){
