...
?>
    ...
    <?  else :?>
       ...
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/manpower_count/export')?>" />
          ...
          <div id="form-div">
            <div class="col-2-form">
                ...
                <div class="form-item odd ">
                    <label class="label-desc gray" for="department">Company:</label>
                    <div class="multiselect-input-wrap">
                        <select id="company_list" style="width:400px;" name="company_list">
                            <?php
