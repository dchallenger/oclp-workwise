...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
            <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/dialed_hours/export')?>" />
            <input type="hidden" name="previous_page" id="previous_page" value="<?=base_url().$this->module_link?>/detail"/>        
            <div id="form-div">
                <div class="col-1-form"> 
                    <div class="form-item odd">
                        <div class="form-item odd">
                            <label class="label-desc gray" for="date_period">Date:</label>
                            <div class="text-input-wrap">
                                <input type="text" name="date" id="date" style="width:30%;" class="input-text date"/> &nbsp; to &nbsp;
                                <input type="text" name="date_to" id="date_to" style="width:30%;" class="input-text date"/>
                                <!-- <div class="icon-label" style="margin-left:20px">
                        ...
                        <div class="form-item odd">
                            <label class="label-desc gray" for="date_period">Campaign:</label>
                            <div class="text-input-wrap">
                                <select name="campaign_id" id="campaign_id" style="width:30%">
                        ...
                        <!-- <input type="button" name="view_list" onClick="generate_list()" value="View List"> -->
                        <div class="form-submit-btn">
                            <div class="icon-label-group">
                                <div class="icon-label">
                                    <a class="icon-16-search-opts" href="javascript:void(0);" onclick="generate_list();" rel="record-save">
                                        <span>Generate List</span>
                                    </a>
                                </div>
                                <div class="icon-label">
                                    <a class="icon-16-export" onclick="export_list();" href="javascript:void(0);" rel="record-save">
                                        <span>Export</span>
                                    </a>
                                </div>
                            </div>
