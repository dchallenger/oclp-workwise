...
<div class="icon-label-group">
    <span class="<?php echo ($record_id < 0) ? 'form-submit-btn' : '' ?> <?php echo $show_wizard_control && isset($fieldgroups) && sizeof($fieldgroups) > 1 && $record_id < 0? 'hidden' : '' ?>">
    	<?php if($record_id == '-1'): ?>
        	<div class="icon-label"> <a onclick="save_movement_draft('back', <?php echo $show_wizard_control ? 1 : 0 ?>)" href="javascript:void(0);" class="icon-16-disk" rel="record-save"> <span>Save as Draft</span> </a> </div>
    	<?php endif; ?>
        ...
        <!-- <div class="icon-label"> <a href="javascript:save_movement_pending()" class="icon-16-send-email" rel="record-save-email"> <span>Save &amp; Send Request</span> </a> </div> -->
        <div class="icon-label"> <a href="javascript:save_movement_back()" class="icon-16-disk-back" rel="record-save-back"> <span>Save &amp; Back</span> </a> </div>
