...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/monthly_movement_report/export')?>" />
            ...
            <div class="col-2-form">
                <div class="form-item odd ">
                    ...
                    <div class="multiselect-input-wrap">
                        <select id="company" style="width:400px;" name="company">
                 ...
                 <div class="form-item even ">
                    <label class="label-desc gray" for="employee_type">Employee Type:</label>
                    <div class="multiselect-input-wrap">
                        <select id="employee_type" style="width:400px;" name="employee_type">
                            <option value="">Select&hellip;</option>
                            <option value="2">Manager-Supervisor</option>                            
                            <option value="1">Non-Supervisory</option>
                        </select>
                    </div>
                </div>
                 ...
                 <div class="form-item odd ">
                   ...
                   <div class="select-input-wrap">
                       <select name ="date_year" id="date_year" style="width:30%">
