...
?>
    ...
    <?  else :?>
       ...
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/retireable_employee/export')?>" />
          ...
          <div id="form-div">
            <div class="col-2-form">
                ...
                <div class="form-item odd ">
                  ...
                  <div class="form-item odd ">
                    <label class="label-desc gray" for="years">No. of Years:</label>
                    <input type="text" name="years" id="years" style="width:77%;" class="input-text"/>
                  </div> 

                  <div class="form-item even ">
                    <label class="label-desc gray" for="retire_type">Retirement Type:</label>
                    <div class="multiselect-input-wrap" id="multi-select-container2">
                        <select id="retire_type" style="width:400px;" name="retire_type[]" multiple="multiple" class="multi-select">
                            <?php
                                $type = array("1"=>"Early Retirement 1","2"=>"Early Retirement 2","3"=>"Normal");
                  ...
                  <div class="form-item odd">
                    <label class="label-desc gray" for="date_asof">
                        As of
                    </label>
                    <div class="text-input-wrap">
                        <input type="text" readonly="readonly" class="input-text  datepicker date" id="date_asof" name="date_asof" value="<?= $date_from ?>"/>
                    </div>
                </div> 
    ...
    <div class="form-submit-btn">
            <div class="icon-label-group">
                <div class="icon-label">
                    <a rel="record-save" class="icon-16-search-opts" onclick="generate_list();" href="javascript:void(0);">
