<script type="text/javascript">
    <?php if ($this->input->post('mrf_id_posted')): ?>
        var mrf_id_posted = <?php echo $this->input->post("mrf_id_posted") ?>;
        $('#record-form').prepend('<input type="hidden" name="mrf_id" id="mrf_id_posted" value="'+ mrf_id_posted +'">');
    <?php endif; ?>
...
?>
                            ...
                            gridComplete:function(){
                                $('#pg_jqgridpager').hide();
                                $('#pg_jqgridcontainer_toppager').hide();
                            },
...
<? endif; ?>
                    ...
                    $("#t_jqgridcontainer").append($('.search-wrap').html());
										 $("#t_jqgridcontainer").append('<?php echo $candidate_tab?>');
