...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
            <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/roster2/export')?>" />
            ...
            <div id="form-div">
                <div class="col-2-form"> 
                    ...
                    <div class="form-item even" id="multi-select-main-container1" style="display:none">
