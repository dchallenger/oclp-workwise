...
?>
    ...
    <?  else :?>
       ...
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/service_award_report/export')?>" />
                ...
                <div class="form-item odd ">
                  ...
                  <div class="form-item odd">
                    ...
                    <div class="text-input-wrap">
                        <input type="text" readonly="readonly" class="input-text  datepicker date" id="date_asof" name="date_asof" value="<?=date('m/d/Y') ?>"/>
                    </div>
                </div> 
