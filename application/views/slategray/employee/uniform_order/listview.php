...
?>
    ...
    <?  else :?>
       ...
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('employee/uniform_order/export')?>" />
            ...
            <div class="col-2-form">
                  ...
                  <div class="form-item odd ">
                    ...
                    <div class="multiselect-input-wrap">
                        <select style="width:400px;" name="company" id="company">
                ...
                <div class="form-item even">
                    <label class="label-desc gray" for="year">
                        Year
                    </label>
                    <div class="multiselect-input-wrap">
                        <select name="yearpicker" id="yearpicker" style="width:400px;">
                 ...
                 <div class="form-item even">
                    <label class="label-desc gray" for="gender" id="category_selected">Gender:</label>
                    <div class="radio-input-wrap">
                        <input type="radio" class="input-radio" value="male" id="gender_male" name="gender">
                        <label class="check-radio-label gray" for="gender_male">Male</label>
                        <input type="radio" class="input-radio" value="female" id="gender_female" name="gender">
                        <label class="check-radio-label gray" for="gender_female">Female</label>
