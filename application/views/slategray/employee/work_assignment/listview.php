            ...
            <div class="select-input-wrap">            
                <?
                    ...
                    if ($result && $result->num_rows() > 0){
                        print '<select id="employee_id" name="employee_id"><option value="">Select…</option>';
                        foreach ($result->result() as $row) {
                            print '<option value="'.$row->employee_id.'">'.$row->firstname.'&nbsp;'.$row->middleinitial.'&nbsp;'.$row->lastname.'&nbsp;'.$row->aux.'</option>';
                        }
                        print '</select>';
                    }
                ?>
