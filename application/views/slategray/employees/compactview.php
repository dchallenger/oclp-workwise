    ...
    <?php
            if (isset($fieldgroups) && sizeof($fieldgroups) > 0) :
                ...
                foreach ($fieldgroups as $fieldgroup) :
                    ?>
    <li style="height:72px;"> <a class="leftcol-control" rel="fg-<?php echo $fieldgroup['fieldgroup_id'] ?>" href="javascript:void(0)"><span class="wizard-ctr"><?php echo $ctr++; ?></span><br />
  ...
  <div class="wizard-header">
    ...
    <?php endif;?>
      ...
      <form class="style2 detail-view" name="record-form" id="record-form" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="return_record_id" id="return_record_id" value="<?php echo isset( $duplicate ) ? '-1' : $this->input->post('record_id') ?>" />
        ...
        <div fg_id="<?php echo $fieldgroup['fieldgroup_id'] ?>" id="fg-<?php echo $fieldgroup['fieldgroup_id'] ?>" class="<?php echo $show_wizard_control ? 'wizard-type-form hidden' : '' ?>">
          ...
          <?php if($show_buttons) :?>
          <div class="icon-label-group align-left"> <?php echo $this->load->view($buttons);?>
