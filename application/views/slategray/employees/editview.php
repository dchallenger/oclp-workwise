...
if (!isset($buttons)) {
    $buttons = 'template/edit-buttons_employee';
}
    ...
    <?php
            if (isset($fieldgroups) && sizeof($fieldgroups) > 0) :
                ...
                foreach ($fieldgroups as $fieldgroup) :
                  if( in_array($fieldgroup['display'], array(1,3) ) ) :   ?>
  ...
  <form enctype="multipart/form-data" method="post" id="record-form" name="record-form" class="style2 edit-view">
    ...
    <div id="form-div">
      <?php foreach ($fieldgroups as $fieldgroup) :
        if( in_array($fieldgroup['display'], array(1,3) ) ) : ?>
          <div fg_id="<?php echo $fieldgroup['fieldgroup_id'] ?>" id="fg-<?php echo $fieldgroup['fieldgroup_id'] ?>" class="<?php echo $show_wizard_control ? 'wizard-type-form hidden' : '' ?> <?php echo ($fieldgroup['standard_custom_view'] == 1 ? 'scv' : '')?>">
            ...
            <?php $this->load->view($buttons)?>
              <?php if ($fieldgroup['standard_custom_view'] != 1): ?>            
