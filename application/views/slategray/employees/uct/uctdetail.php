...
<div class="form-item view odd ">
   <label for="perm_address1" class="label-desc view gray"> Employee Name </label>
...
<div class="form-item view even ">
   <label for="perm_address1" class="label-desc view gray"> Primary Contact Number </label>
   <div class="text-input-wrap">
...
<div class="form-item view odd ">
   <label for="perm_address1" class="label-desc view gray"> Alternate Contact Number </label>
   <div class="text-input-wrap">
      <?php 
...
<div class="form-item view even ">
   <label for="perm_address1" class="label-desc view gray"> Address 1 </label>
   <div class="text-input-wrap">
...
<div class="form-item view odd ">
   <label for="perm_address1" class="label-desc view gray"> Address 2 </label>
   <div class="text-input-wrap">
 ...
 <div class="form-item view even ">
   <label for="perm_address1" class="label-desc view gray"> City </label>
   <div class="text-input-wrap">
...
<div class="form-item view odd ">
   <label for="perm_address1" class="label-desc view gray"> Province </label>
   <div class="text-input-wrap">
...
<div class="form-item view even ">
   <label for="perm_address1" class="label-desc view gray"> Zip Code </label>
   <div class="text-input-wrap">
      <?php if($primary_val['pres_zipcode']!=="")  echo $primary_val['pres_zipcode']; 
      else echo "&nbsp;";?>
   </div>        
</div>
</div>
...
<div class="form-item view odd ">
   <label for="perm_address1" class="label-desc view gray"> Province </label>
   <div class="text-input-wrap">
      <?php if($alternate_val['pres_province']!==""  || $primary_val['pres_province']!==null)   echo $alternate_val['pres_province']."&nbsp;"; 
      else echo "&nbsp;";?>
   </div>        
</div>
<div class="form-item view odd ">
   <label for="perm_address1" class="label-desc view gray"> Zip Code </label>
   <div class="text-input-wrap">
      <?php if($alternate_val['pres_zipcode']!=="")   echo $alternate_val['pres_zipcode']; 
      else echo "&nbsp;";?>
   </div>        
</div>
</div>
...
<?php
      ...
      $this->db->join('cities','employee.pres_city = cities.city_id','left');
      $this->db->where('user.department_id',$this->input->post('record_id'));
      $other_contact=$this->db->get('user')->result_array();
      if (count($other_contact) > 0){
         print '<h3 class="form-head">Other Contact</h3><br />';
         foreach($other_contact as $primary_field => $primary_val){         
?>
            <div class="col-1-form view">
            <div class="form-item view odd ">
               <label for="perm_address1" class="label-desc view gray"> Employee Name </label>
            ...
            <div class="form-item view even ">
               <label for="perm_address1" class="label-desc view gray"> Primary Contact Number </label>
               <div class="text-input-wrap">
                  <?php if($primary_val['home_phone']!=="") echo $primary_val['home_phone']; 
                  else echo "&nbsp;";?>
               </div>        
            </div>
            <div class="form-item view odd ">
               <label for="perm_address1" class="label-desc view gray"> Alternate Contact Number </label>
               <div class="text-input-wrap">
                  <?php if($primary_val['mobile']!==null || $primary_val['mobile']!=="") echo $primary_val['mobile']."&nbsp;"; 
                  else echo "&nbsp;";?>
               </div>        
            </div>
            <div class="form-item view even ">
