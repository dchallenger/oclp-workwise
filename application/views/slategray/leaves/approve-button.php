<div class="form-submit-btn">
  ...
  <div class="icon-label-group">
    <?php if( $rec->remarked_by_hr == 0 && $rec->application_form_id == 1):
      $show_or = true;?>
      <div class="icon-label">
          <a class="icon-16-comments" href="javascript:void(0);" onclick="change_status_boxy(<?php echo $this->key_field_val?>, 6, goto_detail)">
          <span>For HR Validation</span>
          </a>            
      </div>
    <?php endif; ?>
