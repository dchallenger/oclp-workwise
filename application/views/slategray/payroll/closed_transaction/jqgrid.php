    ...
    $(document).ready(function(){
        $("#jqgridcontainer").jqGrid({
            ...
            loadComplete: function(data){
                ...
                if( data.update_employee_list == 'true' ){
                    $('select[name="filter-employee_id"]').html('');
                    $('select[name="filter-employee_id"]').html(data.employee_list);
                    $('select[name="filter-employee_id"]').trigger("liszt:updated");
                }
            },
