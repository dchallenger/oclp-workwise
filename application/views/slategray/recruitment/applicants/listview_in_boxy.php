...
?>
            ...
            postData: {related_module:true, fieldname: '<?= $this->input->post('fieldname') ?>', column: '<?= $this->input->post('column') ?>', container : "<?= $container ?>", fmlinkctr: "<?= $fmlinkctr ?>", other: "<?= $other ?>" <?php echo isset($mrf_id) ? ', mrf: "'.$mrf_id .'"' : ''?>}
        });
