    ...
    <tbody>
        ...
        <tr>
            <td style="border:1px #333 solid">
                1. <input type="text" name="description_1[]" value="<?php echo $description_1[0];?>" <?=(!$this->is_admin) ? 'readonly' : '' ?>/>
            </td>
            <td style="border:1px #333 solid">
        ...
        <tr>
            <td style="border:1px #333 solid">
                2. <input type="text" name="description_1[]" value="<?php echo $description_1[1];?>" <?=(!$this->is_admin) ? 'readonly' : '' ?>/>
            </td>
            <td style="border:1px #333 solid">
        ...
        <tr>
            <td style="border:1px #333 solid">
                3. <input type="text" name="description_1[]" value="<?php echo $description_1[2];?>" <?=(!$this->is_admin) ? 'readonly' : '' ?>/>
            </td>
            <td style="border:1px #333 solid">
