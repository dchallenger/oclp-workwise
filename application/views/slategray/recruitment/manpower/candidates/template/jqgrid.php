<?php
if (!isset($listview)) {
    $listview = $this->module_link . '/listview';
}
?>
<script type="text/javascript">
    $(document).ready(function(){
        $("#jqgridcontainer").jqGrid({
            url: module.get_value('base_url') + '<?php echo $listview; ?>',
...
<? if (isset($default_query)) : ?>
                search: true,
                postData: {searchField: "<?php echo $default_query_field; ?>", searchOper: "eq", searchString: "<?php echo $default_query_val; ?>"},
<? endif; ?>
...
<? endif; ?>
    ...
    function gridResize_jqgridcontainer() {                            
        $("#jqgridcontainer").jqGrid("setGridWidth",$(".rightpane").width());
    }
