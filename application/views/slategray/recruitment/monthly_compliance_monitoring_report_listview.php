...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('recruitment/monthly_compliance_monitoring_report/export')?>" />
          ...
          <!--       <div class="form-item odd ">
                 ...
                 <div class="form-item even ">
                    <label class="label-desc gray" for="date_year">Year:<span class="red font-large">*</span></label>
                    <div class="select-input-wrap">
                        <select name ="date_month" style="width:30%">
                            <option value="">Select..</option>
                          <?php
                              $list_of_month = array("01"=>"Jan","02"=>"Feb","03"=>"Mar","04"=>"Apr","05"=>"May","06"=>"Jun","07"=>"Jul","08"=>"Aug","09"=>"Sept","10"=>"Oct","11"=>"Nov","12"=>"Dec");
                              foreach($list_of_month as $month_int => $month)
                                echo "<option value='".$month_int."'>".$month."</option>";
                          ?>
                        </select>
                    </div>
                </div>                
