...
?>
    ...
    <?  else :?>
       <form id="export-form" method="post" action="">
          <input type="hidden" name="export_link" id="export_link" value="<?=site_url('training/percent_of_idp_accomplished/export')?>" />
          ...
          <div id="form-div">
            <div class="col-2-form">
                ...
                <div class="form-item even ">
                    <label class="label-desc gray" for="leave_period">Date:</label>
                      <div class="text-input-wrap">
                        <input type="text" name="date_start" id="date_start" style="width:30%;" class="input-text date"/>
                        &nbsp;&nbsp;&nbsp;to&nbsp;&nbsp;&nbsp;
                        <input type="text" name="date_end" id="date_end" style="width:30%;" class="input-text date"/>
                      </div>
                  </div>    
                 <div class="form-item odd" id="multi-select-main-container1">
                    <label class="label-desc gray" for="division">Division:</label>
                    <div class="multiselect-input-wrap">
                        <select multiple="multiple" class="multi-select" name="division[]" id="division">
                            <?php
                ...
                <div class="form-item odd" id="multi-select-main-container2">
                    ...
                    <div class="multiselect-input-wrap">
                        <select  multiple="multiple" class="multi-select" name="department[]" id="department">
                            <?php
