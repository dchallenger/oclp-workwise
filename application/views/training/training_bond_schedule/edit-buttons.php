<div class="icon-label-group">
      ...
      <div class="icon-label">
          <a rel="record-save" class="icon-16-disk" href="javascript:void(0);" onclick="bond_ajax_save('', <?php echo $show_wizard_control ? 1 : 0 ?>)">
              <span>Save</span>
          </a>
      </div>
      <div class="icon-label">
          <a rel="record-save-back" class="icon-16-disk-back" href="javascript:void(0);" onclick="bond_ajax_save('back', <?php echo $show_wizard_control ? 1 : 0 ?>)">
              <span>Save &amp; Back</span>
          </a>
      </div>
    <?php endif?>
