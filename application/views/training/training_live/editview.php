...
function validate_fg57(){

    var reason_error_count = 0;

        if($('input[name=reason_for_request]:checked').length == 0){
            reason_error_count = 1;
        }

    if (reason_error_count == 1){
            var error_str = "Please correct the following errors:<br />";
            error_str = error_str + "1. Nature of Request - This field is mandatory."
