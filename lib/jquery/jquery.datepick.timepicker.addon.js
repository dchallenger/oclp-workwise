		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			...
			if (o.showHour && o.hourGrid > 0) {
				...
				$tp.find(".ui_tpicker_hour table").css({
					// width: size + "%", //commented to resolved issue hour alignment in datetimepicker
					marginLeft: "-7%", //fixed margin to align hour value on select datetime picker
			...
			if (o.showMinute && o.minuteGrid > 0) {
				...
				$tp.find(".ui_tpicker_minute table").css({
					// width: size + "%", //commented to resolved issue minute alignment in datetimepicker
					marginLeft: "-7%", //fixed margin to align minute value on select datetime picker
					borderCollapse: 'collapse'
				}).find("td").each(function(index) {
					$(this).click(function() {
