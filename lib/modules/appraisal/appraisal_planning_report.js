    ...
    window.onload = function(){
      ...
      $("#jqgridcontainer").jqGrid('setGroupHeaders', {
            ...
            groupHeaders:[
              ...
              {startColumnName: 'approved', numberOfColumns: 3, titleText: '<span style="font-weight:bold;">Status</span>'}
            ]
      }).trigger("reloadGrid");
    }
});
...
function export_list()
{
	if( ( $('#planning_period_id').val() == "" )){
        ...
        $('#message-container').html(message_growl('error', 'Period - This field is mandatory.')); 
