    ...
    window.onload = function(){
      ...
      $("#jqgridcontainer").jqGrid('setGroupHeaders', {
            ...
            groupHeaders:[
              ...
              {startColumnName: 'financial_perspective', numberOfColumns: 12, titleText: '<span style="font-weight:bold;">Company Objectives / Goals</span>'},
              {startColumnName: 'customer_orientation', numberOfColumns: 6, titleText: '<span style="font-weight:bold;">Core Competencies</span>'},
              {startColumnName: 'attendance_and_punctuality', numberOfColumns: 2, titleText: '<span style="font-weight:bold;">Attendance</span>'},
              {startColumnName: 'innovation', numberOfColumns: 6, titleText: '<span style="font-weight:bold;">Corporate Values</span>'},
              {startColumnName: 'coachs_rating', numberOfColumns: 1, titleText: '<span style="font-weight:bold;">Rating</span>'}
            ]
      }).trigger("reloadGrid");
    }
});
...
function generate_list(){
    ...
    if( ( $('#planning_period_id').val() == "" )){
  
        $('#message-container').html(message_growl('error', 'Periods - This field is mandatory.')); 
...
function list_search_grid( jqgridcontainer ){
	...
	$("#"+jqgridcontainer).jqGrid('setGridParam', 
	{
		...
		postData: {
			...
			planning_period_id : $('#planning_period_id').val()
		}, 	
	}).trigger("reloadGrid");
